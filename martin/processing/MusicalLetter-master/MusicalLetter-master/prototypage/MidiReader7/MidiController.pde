...
public class MidiController {
  ...
  MidiController() {
    ...
    dir = new File("C:\\Users\\mmeurin\\Documents\\Lab-proximityBBDO\\Lab-proximityBBDO\\noel\\lettre_musical\\processing\\MusicalLetter-master\\MusicalLetter-master\\prototypage\\MidiReader7\\midi");
    list = dir.list();
    println(dir.list());
  }
  ...
  public void playingMidi(int index) {
    ...
    try {
      ...
      for (int i = 0; i < list.length; ++i) {
        ...
        if (isMidi) {
          if (i == index) {
            File midiFile = new File(dataPath("C:\\Users\\mmeurin\\Documents\\Lab-proximityBBDO\\Lab-proximityBBDO\\noel\\lettre_musical\\processing\\MusicalLetter-master\\MusicalLetter-master\\prototypage\\MidiReader7\\midi\\"+list[i]));
